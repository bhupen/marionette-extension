    ...
    grunt.initConfig({
        ...
        uglify: {
            dist: {
                ...
                files: [
                    {
                        src: 'marionette.extension.js',
                        dest: 'dist/marionette.extension.min.js'
                    }
                ]
            }
        },
        jshint: {
            all: ['Gruntfile.js', 'backbone.context.js', 'specs/*.js']
        },
        ...
        "jsbeautifier": {
            fix: {
                src: ['beautify.json', 'Gruntfile.js', 'backbone.context.js', 'specs/*.js'],
                options: {
